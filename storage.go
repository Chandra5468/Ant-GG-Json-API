...
type PostgresStore struct {
	db *sql.DB // This is a default sql package provided by golang. Use this in conjuction with postgresql package.
}

func NewPostgresStore() (*PostgresStore, error) {
	// Check go postgresql document for connection establishment.
	connstr := "user=myuser dbname=test1 password=user host=localhost port=5432 sslmode=disable"
